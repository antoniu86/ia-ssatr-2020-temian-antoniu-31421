...
public class TestTrackJFrame extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(comboCarType, 0, 241, Short.MAX_VALUE)
    ...
    private void buttonAddCarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddCarActionPerformed
        ...
        String plate = this.testPlateNumber.getText();
               
        if(type.equals("Electric car")){
            ElectricCar c = new ElectricCar(name, speed, plate);
            track.addCar(c);
            jTextArea1.append("New electric car added, plate: "+plate+".\n");
        }else if (type.equals("Diesel car")){
            DieselCar c = new DieselCar(name, speed, plate);
            track.addCar(c);            
            jTextArea1.append("New diesel car added, plate: "+plate+".\n");
        }else if (type.equals("Otto car")){
            OttoCar c = new OttoCar(name, speed, plate);
            track.addCar(c);            
            jTextArea1.append("New otto car added, plate: "+plate+".\n");
        }else{
