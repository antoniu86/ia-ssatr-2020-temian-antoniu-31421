...
public class TestTrack {
   ...
   String getAllCarsDetails(){
       ...
       for(Car c: cars){ 
           if(c!=null){
            String line = "Car name="+c.getName()+" speed="+c.speed+" plate="+c.plate+"\n";
            all=all+line;
           }
       }
       return all;
    ...
    public static void main(String[] args) {
        ...
        track1.addCar(new ElectricCar("Tesla 1", 0, "plate"));
        track1.addCar(new ElectricCar("Tesla 2", 0, "plate"));
        track1.addCar(new DieselCar("Tesla 2", 0, "plate"));
        track1.addCar(new DieselCar("Tesla 2", 0, "plate"));
