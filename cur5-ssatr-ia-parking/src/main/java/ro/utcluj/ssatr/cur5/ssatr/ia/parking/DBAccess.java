...
public class DBAccess {
    ...
    public DBAccess() throws ClassNotFoundException, SQLException {
         ...
         conn = DriverManager.getConnection("jdbc:derby://localhost:1527/sample;create=false","app","app");
    }
    ...
    public void addCarToHistory(CarAccessEntity car, long leavetime) throws SQLException{
        Statement s = conn.createStatement();
        s.executeUpdate("INSERT INTO HISTORYACCESS VALUES ('"+car.getPlateNumber()+"',"+car.getEntryTime()+", "+leavetime+")");        
        s.close();       
    }
